...
macro_rules! define_op {
    ($(
        ...
        impl Op {
            ...
            /// Markdown documentation string for the instruction.
...
define_op! {
    opcode = Nop,           name = NOP(0),  field_type = Any,    time = 1,  docs = nop_docs!();
    opcode = Add,           name = ADD(5),  field_type = Word,   time = 2,  docs = add_docs!();
    opcode = Add,           name = FADD(6), field_type = Const,  time = 4,  docs = fadd_docs!();
    opcode = Sub,           name = SUB(5),  field_type = Word,   time = 2,  docs = sub_docs!();
    opcode = Sub,           name = FSUB(6), field_type = Const,  time = 4,  docs = fsub_docs!();
    opcode = Mul,           name = MUL(5),  field_type = Word,   time = 10, docs = mul_docs!();
    opcode = Mul,           name = FMUL(6), field_type = Const,  time = 9,  docs = fmul_docs!();
    opcode = Div,           name = DIV(5),  field_type = Word,   time = 12, docs = div_docs!();
    opcode = Div,           name = FDIV(6), field_type = Const,  time = 11, docs = fdiv_docs!();
    opcode = Special,       name = NUM(0),  field_type = Const,  time = 10, docs = num_docs!();
    opcode = Special,       name = CHAR(1), field_type = Const,  time = 10, docs = char_docs!();
    opcode = Special,       name = HLT(2),  field_type = Const,  time = 1,  docs = hlt_docs!();
    opcode = Special,       name = FLOT(6), field_type = Const,  time = 3,  docs = flot_docs!();
    opcode = Special,       name = FIX(7),  field_type = Const,  time = 3,  docs = fix_docs!();
    opcode = Shift,         name = SLA(0),  field_type = Const,  time = 2,  docs = sla_docs!();
    opcode = Shift,         name = SRA(1),  field_type = Const,  time = 2,  docs = sra_docs!();
    opcode = Shift,         name = SLAX(2), field_type = Const,  time = 2,  docs = slax_docs!();
    opcode = Shift,         name = SRAX(3), field_type = Const,  time = 2,  docs = srax_docs!();
    opcode = Shift,         name = SLC(4),  field_type = Const,  time = 2,  docs = slc_docs!();
    opcode = Shift,         name = SRC(5),  field_type = Const,  time = 2,  docs = src_docs!();
    opcode = Shift,         name = SLB(6),  field_type = Const,  time = 2,  docs = slb_docs!();
    opcode = Shift,         name = SRB(7),  field_type = Const,  time = 2,  docs = srb_docs!();
    opcode = Move,          name = MOVE(1), field_type = Any,    time = 1,  docs = move_docs!();
    opcode = LoadA,         name = LDA(5),  field_type = Word,   time = 2,  docs = load_docs!("LDA", "A");
    opcode = Load1,         name = LD1(5),  field_type = Word,   time = 2,  docs = load_index_docs!("LD1", "I1");
    opcode = Load2,         name = LD2(5),  field_type = Word,   time = 2,  docs = load_index_docs!("LD2", "I2");
    opcode = Load3,         name = LD3(5),  field_type = Word,   time = 2,  docs = load_index_docs!("LD3", "I3");
    opcode = Load4,         name = LD4(5),  field_type = Word,   time = 2,  docs = load_index_docs!("LD4", "I4");
    opcode = Load5,         name = LD5(5),  field_type = Word,   time = 2,  docs = load_index_docs!("LD5", "I5");
    opcode = Load6,         name = LD6(5),  field_type = Word,   time = 2,  docs = load_index_docs!("LD6", "I6");
    opcode = LoadX,         name = LDX(5),  field_type = Word,   time = 2,  docs = load_docs!("LDX", "X");
    opcode = LoadANegative, name = LDAN(5), field_type = Word,   time = 2,  docs = load_neg_docs!("LDAN", "A");
    opcode = Load1Negative, name = LD1N(5), field_type = Word,   time = 2,  docs = load_neg_index_docs!("LD1N", "I1");
    opcode = Load2Negative, name = LD2N(5), field_type = Word,   time = 2,  docs = load_neg_index_docs!("LD2N", "I2");
    opcode = Load3Negative, name = LD3N(5), field_type = Word,   time = 2,  docs = load_neg_index_docs!("LD3N", "I3");
    opcode = Load4Negative, name = LD4N(5), field_type = Word,   time = 2,  docs = load_neg_index_docs!("LD4N", "I4");
    opcode = Load5Negative, name = LD5N(5), field_type = Word,   time = 2,  docs = load_neg_index_docs!("LD5N", "I5");
    opcode = Load6Negative, name = LD6N(5), field_type = Word,   time = 2,  docs = load_neg_index_docs!("LD6N", "I6");
    opcode = LoadXNegative, name = LDXN(5), field_type = Word,   time = 2,  docs = load_neg_docs!("LDXN", "X");
    opcode = StoreA,        name = STA(5),  field_type = Word,   time = 2,  docs = store_docs!("STA", "A");
    opcode = Store1,        name = ST1(5),  field_type = Word,   time = 2,  docs = store_index_docs!("ST1", "I1");
    opcode = Store2,        name = ST2(5),  field_type = Word,   time = 2,  docs = store_index_docs!("ST2", "I2");
    opcode = Store3,        name = ST3(5),  field_type = Word,   time = 2,  docs = store_index_docs!("ST3", "I3");
    opcode = Store4,        name = ST4(5),  field_type = Word,   time = 2,  docs = store_index_docs!("ST4", "I4");
    opcode = Store5,        name = ST5(5),  field_type = Word,   time = 2,  docs = store_index_docs!("ST5", "I5");
    opcode = Store6,        name = ST6(5),  field_type = Word,   time = 2,  docs = store_index_docs!("ST6", "I6");
    opcode = StoreX,        name = STX(5),  field_type = Word,   time = 2,  docs = store_docs!("STX", "X");
    opcode = StoreJ,        name = STJ(2),  field_type = Word,   time = 2,  docs = stj_docs!();
    opcode = StoreZ,        name = STZ(5),  field_type = Word,   time = 2,  docs = stz_docs!();
    opcode = JumpBusy,      name = JBUS(0), field_type = Device, time = 1,  docs = jbus_docs!();
    opcode = IoControl,     name = IOC(0),  field_type = Device, time = 1,  docs = ioc_docs!();
    opcode = In,            name = IN(0),   field_type = Device, time = 1,  docs = in_docs!();
    opcode = Out,           name = OUT(0),  field_type = Device, time = 1,  docs = out_docs!();
    opcode = JumpReady,     name = JRED(0), field_type = Device, time = 1,  docs = jred_docs!();
    opcode = Jump,          name = JMP(0),  field_type = Const,  time = 1,  docs = jmp_docs!();
    opcode = Jump,          name = JSJ(1),  field_type = Const,  time = 1,  docs = jsj_docs!();
    opcode = Jump,          name = JOV(2),  field_type = Const,  time = 1,  docs = jov_docs!();
    opcode = Jump,          name = JNOV(3), field_type = Const,  time = 1,  docs = jnov_docs!();
    opcode = Jump,          name = JL(4),   field_type = Const,  time = 1,  docs = jump_compare_docs!("JL", "less", "`LESS`");
    opcode = Jump,          name = JE(5),   field_type = Const,  time = 1,  docs = jump_compare_docs!("JE", "equal", "`EQUAL`");
    opcode = Jump,          name = JG(6),   field_type = Const,  time = 1,  docs = jump_compare_docs!("JG", "greater", "`GREATER`");
    opcode = Jump,          name = JGE(7),  field_type = Const,  time = 1,  docs = jump_compare_docs!("JGE", "greater or equal", "`GREATER` or `EQUAL`");
    opcode = Jump,          name = JNE(8),  field_type = Const,  time = 1,  docs = jump_compare_docs!("JNE", "unequal", "`LESS` or `GREATER`");
    opcode = Jump,          name = JLE(9),  field_type = Const,  time = 1,  docs = jump_compare_docs!("JLE", "less or equal", "`LESS` or `EQUAL`");
    opcode = JumpA,         name = JAN(0),  field_type = Const,  time = 1,  docs = jump_docs!("JAN", "A", N);
    opcode = JumpA,         name = JAZ(1),  field_type = Const,  time = 1,  docs = jump_docs!("JAZ", "A", Z);
    opcode = JumpA,         name = JAP(2),  field_type = Const,  time = 1,  docs = jump_docs!("JAP", "A", P);
    opcode = JumpA,         name = JANN(3), field_type = Const,  time = 1,  docs = jump_docs!("JANN", "A", NN);
    opcode = JumpA,         name = JANZ(4), field_type = Const,  time = 1,  docs = jump_docs!("JANZ", "A", NZ);
    opcode = JumpA,         name = JANP(5), field_type = Const,  time = 1,  docs = jump_docs!("JANP", "A", NP);
    opcode = JumpA,         name = JAE(6),  field_type = Const,  time = 1,  docs = jump_parity_docs!("JAE", "A", "even");
    opcode = JumpA,         name = JAO(7),  field_type = Const,  time = 1,  docs = jump_parity_docs!("JAO", "A", "odd");
    opcode = Jump1,         name = J1N(0),  field_type = Const,  time = 1,  docs = jump_docs!("J1N", "I1", N);
    opcode = Jump1,         name = J1Z(1),  field_type = Const,  time = 1,  docs = jump_docs!("J1Z", "I1", Z);
    opcode = Jump1,         name = J1P(2),  field_type = Const,  time = 1,  docs = jump_docs!("J1P", "I1", P);
    opcode = Jump1,         name = J1NN(3), field_type = Const,  time = 1,  docs = jump_docs!("J1NN", "I1", NN);
    opcode = Jump1,         name = J1NZ(4), field_type = Const,  time = 1,  docs = jump_docs!("J1NZ", "I1", NZ);
    opcode = Jump1,         name = J1NP(5), field_type = Const,  time = 1,  docs = jump_docs!("J1NP", "I1", NP);
    opcode = Jump2,         name = J2N(0),  field_type = Const,  time = 1,  docs = jump_docs!("J2N", "I2", N);
    opcode = Jump2,         name = J2Z(1),  field_type = Const,  time = 1,  docs = jump_docs!("J2Z", "I2", Z);
    opcode = Jump2,         name = J2P(2),  field_type = Const,  time = 1,  docs = jump_docs!("J2P", "I2", P);
    opcode = Jump2,         name = J2NN(3), field_type = Const,  time = 1,  docs = jump_docs!("J2NN", "I2", NN);
    opcode = Jump2,         name = J2NZ(4), field_type = Const,  time = 1,  docs = jump_docs!("J2NZ", "I2", NZ);
    opcode = Jump2,         name = J2NP(5), field_type = Const,  time = 1,  docs = jump_docs!("J2NP", "I2", NP);
    opcode = Jump3,         name = J3N(0),  field_type = Const,  time = 1,  docs = jump_docs!("J3N", "I3", N);
    opcode = Jump3,         name = J3Z(1),  field_type = Const,  time = 1,  docs = jump_docs!("J3Z", "I3", Z);
    opcode = Jump3,         name = J3P(2),  field_type = Const,  time = 1,  docs = jump_docs!("J3P", "I3", P);
    opcode = Jump3,         name = J3NN(3), field_type = Const,  time = 1,  docs = jump_docs!("J3NN", "I3", NN);
    opcode = Jump3,         name = J3NZ(4), field_type = Const,  time = 1,  docs = jump_docs!("J3NZ", "I3", NZ);
    opcode = Jump3,         name = J3NP(5), field_type = Const,  time = 1,  docs = jump_docs!("J3NP", "I3", NP);
    opcode = Jump4,         name = J4N(0),  field_type = Const,  time = 1,  docs = jump_docs!("J4N", "I4", N);
    opcode = Jump4,         name = J4Z(1),  field_type = Const,  time = 1,  docs = jump_docs!("J4Z", "I4", Z);
    opcode = Jump4,         name = J4P(2),  field_type = Const,  time = 1,  docs = jump_docs!("J4P", "I4", P);
    opcode = Jump4,         name = J4NN(3), field_type = Const,  time = 1,  docs = jump_docs!("J4NN", "I4", NN);
    opcode = Jump4,         name = J4NZ(4), field_type = Const,  time = 1,  docs = jump_docs!("J4NZ", "I4", NZ);
    opcode = Jump4,         name = J4NP(5), field_type = Const,  time = 1,  docs = jump_docs!("J4NP", "I4", NP);
    opcode = Jump5,         name = J5N(0),  field_type = Const,  time = 1,  docs = jump_docs!("J5N", "I5", N);
    opcode = Jump5,         name = J5Z(1),  field_type = Const,  time = 1,  docs = jump_docs!("J5Z", "I5", Z);
    opcode = Jump5,         name = J5P(2),  field_type = Const,  time = 1,  docs = jump_docs!("J5P", "I5", P);
    opcode = Jump5,         name = J5NN(3), field_type = Const,  time = 1,  docs = jump_docs!("J5NN", "I5", NN);
    opcode = Jump5,         name = J5NZ(4), field_type = Const,  time = 1,  docs = jump_docs!("J5NZ", "I5", NZ);
    opcode = Jump5,         name = J5NP(5), field_type = Const,  time = 1,  docs = jump_docs!("J5NP", "I5", NP);
    opcode = Jump6,         name = J6N(0),  field_type = Const,  time = 1,  docs = jump_docs!("J6N", "I6", N);
    opcode = Jump6,         name = J6Z(1),  field_type = Const,  time = 1,  docs = jump_docs!("J6Z", "I6", Z);
    opcode = Jump6,         name = J6P(2),  field_type = Const,  time = 1,  docs = jump_docs!("J6P", "I6", P);
    opcode = Jump6,         name = J6NN(3), field_type = Const,  time = 1,  docs = jump_docs!("J6NN", "I6", NN);
    opcode = Jump6,         name = J6NZ(4), field_type = Const,  time = 1,  docs = jump_docs!("J6NZ", "I6", NZ);
    opcode = Jump6,         name = J6NP(5), field_type = Const,  time = 1,  docs = jump_docs!("J6NP", "I6", NP);
    opcode = JumpX,         name = JXN(0),  field_type = Const,  time = 1,  docs = jump_docs!("JXN", "X", N);
    opcode = JumpX,         name = JXZ(1),  field_type = Const,  time = 1,  docs = jump_docs!("JXZ", "X", Z);
    opcode = JumpX,         name = JXP(2),  field_type = Const,  time = 1,  docs = jump_docs!("JXP", "X", P);
    opcode = JumpX,         name = JXNN(3), field_type = Const,  time = 1,  docs = jump_docs!("JXNN", "X", NN);
    opcode = JumpX,         name = JXNZ(4), field_type = Const,  time = 1,  docs = jump_docs!("JXNZ", "X", NZ);
    opcode = JumpX,         name = JXNP(5), field_type = Const,  time = 1,  docs = jump_docs!("JXNP", "X", NP);
    opcode = JumpX,         name = JXE(6),  field_type = Const,  time = 1,  docs = jump_parity_docs!("JXE", "X", "even");
    opcode = JumpX,         name = JXO(7),  field_type = Const,  time = 1,  docs = jump_parity_docs!("JXO", "X", "odd");
    opcode = ModifyA,       name = INCA(0), field_type = Const,  time = 1,  docs = inca_docs!();
    opcode = ModifyA,       name = DECA(1), field_type = Const,  time = 1,  docs = deca_docs!();
    opcode = ModifyA,       name = ENTA(2), field_type = Const,  time = 1,  docs = enter_docs!("ENTA", "A");
    opcode = ModifyA,       name = ENNA(3), field_type = Const,  time = 1,  docs = enter_neg_docs!("ENNA", "A");
    opcode = Modify1,       name = INC1(0), field_type = Const,  time = 1,  docs = increase_index_docs!("INC1", "I1");
    opcode = Modify1,       name = DEC1(1), field_type = Const,  time = 1,  docs = decrease_index_docs!("DEC1", "I1");
    opcode = Modify1,       name = ENT1(2), field_type = Const,  time = 1,  docs = enter_docs!("ENT1", "I1");
    opcode = Modify1,       name = ENN1(3), field_type = Const,  time = 1,  docs = enter_neg_docs!("ENN1", "I1");
    opcode = Modify2,       name = INC2(0), field_type = Const,  time = 1,  docs = increase_index_docs!("INC2", "I2");
    opcode = Modify2,       name = DEC2(1), field_type = Const,  time = 1,  docs = decrease_index_docs!("DEC2", "I2");
    opcode = Modify2,       name = ENT2(2), field_type = Const,  time = 1,  docs = enter_docs!("ENT2", "I2");
    opcode = Modify2,       name = ENN2(3), field_type = Const,  time = 1,  docs = enter_neg_docs!("ENN2", "I2");
    opcode = Modify3,       name = INC3(0), field_type = Const,  time = 1,  docs = increase_index_docs!("INC3", "I3");
    opcode = Modify3,       name = DEC3(1), field_type = Const,  time = 1,  docs = decrease_index_docs!("DEC3", "I3");
    opcode = Modify3,       name = ENT3(2), field_type = Const,  time = 1,  docs = enter_docs!("ENT3", "I3");
    opcode = Modify3,       name = ENN3(3), field_type = Const,  time = 1,  docs = enter_neg_docs!("ENN3", "I3");
    opcode = Modify4,       name = INC4(0), field_type = Const,  time = 1,  docs = increase_index_docs!("INC4", "I4");
    opcode = Modify4,       name = DEC4(1), field_type = Const,  time = 1,  docs = decrease_index_docs!("DEC4", "I4");
    opcode = Modify4,       name = ENT4(2), field_type = Const,  time = 1,  docs = enter_docs!("ENT4", "I4");
    opcode = Modify4,       name = ENN4(3), field_type = Const,  time = 1,  docs = enter_neg_docs!("ENN4", "I4");
    opcode = Modify5,       name = INC5(0), field_type = Const,  time = 1,  docs = increase_index_docs!("INC5", "I5");
    opcode = Modify5,       name = DEC5(1), field_type = Const,  time = 1,  docs = decrease_index_docs!("DEC5", "I5");
    opcode = Modify5,       name = ENT5(2), field_type = Const,  time = 1,  docs = enter_docs!("ENT5", "I5");
    opcode = Modify5,       name = ENN5(3), field_type = Const,  time = 1,  docs = enter_neg_docs!("ENN5", "I5");
    opcode = Modify6,       name = INC6(0), field_type = Const,  time = 1,  docs = increase_index_docs!("INC6", "I6");
    opcode = Modify6,       name = DEC6(1), field_type = Const,  time = 1,  docs = decrease_index_docs!("DEC6", "I6");
    opcode = Modify6,       name = ENT6(2), field_type = Const,  time = 1,  docs = enter_docs!("ENT6", "I6");
    opcode = Modify6,       name = ENN6(3), field_type = Const,  time = 1,  docs = enter_neg_docs!("ENN6", "I6");
    opcode = ModifyX,       name = INCX(0), field_type = Const,  time = 1,  docs = incx_docs!();
    opcode = ModifyX,       name = DECX(1), field_type = Const,  time = 1,  docs = decx_docs!();
    opcode = ModifyX,       name = ENTX(2), field_type = Const,  time = 1,  docs = enter_docs!("ENTX", "X");
    opcode = ModifyX,       name = ENNX(3), field_type = Const,  time = 1,  docs = enter_neg_docs!("ENNX", "X");
    opcode = CompareA,      name = CMPA(5), field_type = Word,   time = 2,  docs = compare_docs!("CMPA", "A");
    opcode = CompareA,      name = FCMP(6), field_type = Const,  time = 4,  docs = fcmp_docs!();
    opcode = Compare1,      name = CMP1(5), field_type = Word,   time = 2,  docs = compare_index_docs!("CMP1", "I1");
    opcode = Compare2,      name = CMP2(5), field_type = Word,   time = 2,  docs = compare_index_docs!("CMP2", "I2");
    opcode = Compare3,      name = CMP3(5), field_type = Word,   time = 2,  docs = compare_index_docs!("CMP3", "I3");
    opcode = Compare4,      name = CMP4(5), field_type = Word,   time = 2,  docs = compare_index_docs!("CMP4", "I4");
    opcode = Compare5,      name = CMP5(5), field_type = Word,   time = 2,  docs = compare_index_docs!("CMP5", "I5");
    opcode = Compare6,      name = CMP6(5), field_type = Word,   time = 2,  docs = compare_index_docs!("CMP6", "I6");
    opcode = CompareX,      name = CMPX(5), field_type = Word,   time = 2,  docs = compare_docs!("CMPX", "X");
}
